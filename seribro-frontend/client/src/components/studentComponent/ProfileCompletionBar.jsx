// frontend/src/components/studentComponent/ProfileCompletionBar.jsx
import React from 'react';
import { CheckCircle, AlertCircle, Clock } from 'lucide-react';

const ProfileCompletionBar = ({ percentage = 0, status = 'draft' }) => {
    ...
    const getStatusBadgeStyle = () => {
        if (normalizedStatus === 'approved' || normalizedStatus === 'verified') return 'bg-emerald-500/20 text-emerald-300 border-emerald-500';
    ...
    const getStatusIcon = () => {
        if (normalizedStatus === 'approved' || normalizedStatus === 'verified') return <CheckCircle size={16} />;
