...
function App() {
  ...
  element={<StudentRoute><StudentPaymentPage /></StudentRoute>} 
/>
<Route 
  path="/admin/payments" 
  element={<AdminRoute><AdminPaymentPage /></AdminRoute>} 
/>
<Route 
  path="/payments/verify" 
  element={<CompanyRoute><PaymentVerificationPage /></CompanyRoute>} 
/>
<Route 
  path="/workspace/projects/:projectId/rating" 
  element={<StudentRoute><RatingPage /></StudentRoute>} 
/>
<Route 
